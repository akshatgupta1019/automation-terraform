...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/akshatgupta1019/automation-terraform.git /var/www/html/"
    ]
  }
}
    ...
    "Statement": [
        {
            ...
            "Principal": "*",
            "Action": "s3:GetObject",
            "Resource": "arn:aws:s3:::akshatkibalti/*"
    }
  ]
}
EOF
...
configuration = {
        Owner  = "akshatgupta1019"
        Repo   = "automation-terraform"
        Branch = "master"
	OAuthToken = "93385fe361afb97aff387fb99a9b02c967df81a5"        
      }
    }
  }
